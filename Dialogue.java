public class Dialogue{
    ...
    public void slimeEncounter(){
        System.out.println("You don't know you got here, but it seems you are in the plains currently");
        System.out.println("There is a forest to the north and a cave to your right");
        System.out.println("Maybe exploring a little will get you some answers");
        System.out.println("As soon as you are about to set off, you see a blob like object approaching you.");
        System.out.println("Oh its a slime, it looks like it wants to fight.");
        System.out.println();
    }
    public void defeated_Slime(){
        System.out.println();
        System.out.println();
        System.out.println();
        System.out.println("You have defeated the slime.");
        System.out.println("You have two choices of where to go next");
        System.out.println("The forest or the cave? Choose carefully (input forest or cave)");
    }
    public void wolfEncounter(){
        ...
        System.out.println("However, you hear a twig snap and a large wolf walks into view, staring at you with its teeth bared.");
    }
    public void defeated_Wolf(){
        System.out.println();
        ...
        System.out.println("Where do you want to go? (input wizard tower or village)");
    }
    public void defeated_Skeleton(){
        ...
        System.out.println("Do you enter the dungeon or go outside the cave? (input dungeon or outside)");
    }
